 ...
 */
(function($){$.fn.responsiveDrawer=function(){return this.each(function(){var drawer=this;var $trigger=$(this);var href=$trigger.attr('href');var $target=$($trigger.attr('data-target')||(href&&href.replace(/.*(?=#[^\s]+$)/,'')));var $html=$('html');drawer.isTemporary=function(){return $.fn.isBreakpoint(['xs','sm','md'])||($.fn.isBreakpoint(['lg'])&&$html.hasClass('touch'));};drawer.isPersistent=function(){return($.fn.isBreakpoint(['lg'])||($.fn.isBreakpoint(['xl'])&&$html.hasClass('touch')))&&!drawer.isTemporary();};drawer.init=function(){if(typeof $target!=='undefined'){if(drawer.isTemporary()){$html.removeClass('on off persistent permanent').addClass('temporary');}else if(drawer.isPersistent()){if(!$html.hasClass('temporary')&&$html.hasClass('touch')){$html.addClass('off');}
